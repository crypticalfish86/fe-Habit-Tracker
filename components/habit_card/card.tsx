  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardContent}>
        <Text style={styles.labels}>Habit: <Text style={styles.content}>{habit_name}</Text></Text>
        <Text style={styles.labels}>Category: <Text style={styles.content}>{habit_category}</Text></Text>
        <Text style={styles.labels}>Type: <Text style={styles.content}>{habit_type}</Text></Text>
        <Text style={styles.labels}>Streak: <Text style={styles.content}>{habit_streak}</Text></Text>
